...
#define DATA_BIT_TIMEOUT		((2.75 * 1000) / TIMER1_TICK_VALUE)		//data bit: latest time for start of a following data bit (in timer2 ticks => 2.75ms) (see HDMI 1.3 CEC specification p. 9)
